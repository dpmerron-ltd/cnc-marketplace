...
grant execute on function public.replace_cnc_component_source(uuid, uuid, text, text, jsonb, text, text, text, jsonb, double precision, double precision, jsonb, jsonb, jsonb) to service_role;
