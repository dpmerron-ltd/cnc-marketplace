...
export interface JobRequest {
  ...
  sheet: { widthMm: number; heightMm: number; material: string; thicknessMm?: number; profilePasses?: 1 | 2; drillDepthMm?: 9; spacingMm: number; borderMm: number; safeZMm: number; screwMarks: boolean }
