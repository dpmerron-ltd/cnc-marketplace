...
describe('item library grid', () => {
  ...
  it('shows the shared library and searches names, SKUs and component files', () => {
    setup()
  ...
  it('sorts and filters without mutating the underlying library', () => {
    ...
    expect(screen.getAllByRole('button', { name: /^Open / })[0]).toHaveAccessibleName('Open Alpha cabinet')
  ...
  it('opens details, edits metadata, uploads and adds components without leaving the item', () => {
    ...
    expect(screen.getByText('Secret component')).toBeInTheDocument()
    ...
    fireEvent.click(screen.getAllByRole('button', { name: 'Add to sheet' })[0])
